# Interactive art — PixiJS scene (project plan)
...
- Follow **[cursor/rules/javascript-staff-engineering.mdc](../cursor/rules/javascript-staff-engineering.mdc)** for JS style when editing `.js` / `.mjs`.
...
- `dark-water.png`, `light-water.png`
- `noise.png` (e.g. light layer), `noise-2.png` (e.g. dark layer)
...
- GitHub Pages: deploy from branch root; confirm only relative paths (`./assets/...`, `./src/main.js`).
...
*Last aligned with repo state: layered water + scroll/wrap fixes in `src/main.js`.*
